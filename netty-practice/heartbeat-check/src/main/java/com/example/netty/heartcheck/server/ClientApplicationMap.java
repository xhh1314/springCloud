...
public class ClientApplicationMap {
     ...
     * 存放客户端地址的容器
     */
    private static final Map<String, List<ClientInfo>> clientMap = new ConcurrentHashMap<String, List<ClientInfo>>(16);

    private static final Map<String, SocketChannel> socketChannelMap = new ConcurrentHashMap<>(32);
